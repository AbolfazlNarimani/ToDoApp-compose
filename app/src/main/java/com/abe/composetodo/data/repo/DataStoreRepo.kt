...
import com.abe.composetodo.ui.util.Constants.PREFERENCE_KEY
import com.abe.composetodo.ui.util.Constants.PREFERENCE_NAME
...
class DataStoreRepo @Inject constructor(
    ...
    fun getSortState(): Flow<String> {
        return dataStore.data
            .map { preferences ->
                preferences[PreferenceKeys.sortKey] ?: "NONE"
            }
    }
}
